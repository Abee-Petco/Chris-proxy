...
describe('The proxy server should correctly serve an index.html file that, in turn, correctly mounts all service components, by', () => {
  ...
  //       const targetDOMelement = iframeDOM.getElementById(
  //         'recommendation-submodule-customer'
  //       );
  ...
  //       const targetDOMelement = iframeDOM.getElementById(
  //         'recommendation-submodule-treat'
  //       );
  ...
  //       const targetDOMelement = iframeDOM.getElementsByClassName(
  //         'galleryMainImageDiv'
  //       );
